...
class WeekendHospitalAction(Resource):
    def post(self):
        ...
        if hospitals_cnt == 0:
            ...
            return create_weekend_message(f"주말에도 운영하는 병원은 {hospitals_cnt}곳으로, 토요일은 {saturday_hospitals}, 일요일은 {sunday_hospitals} 등등이 있습니다.")
...
class WeekendAllHospitalAction(Resource):
    def post(self):
        ...
        return create_weekend_all_message(f"토요일은 {saturday_hospitals}이 있고, 일요일은 {sunday_hospitals}이 있습니다.")
